...
export const topBottomBagShoesLayout: LayoutPattern = {
  пиджак: { left: 0.05, top: 0.05, right: 0.42, bottom: 0.50, zIndex: 1 },
  жакет: { left: 0.05, top: 0.05, right: 0.42, bottom: 0.50, zIndex: 1 },
  топ: { left: 0.30, top: 0.08, right: 0.70, bottom: 0.45, zIndex: 2 },
  брюки: { left: 0.05, top: 0.42, right: 0.40, bottom: 0.85, zIndex: 1 },
  юбка: { left: 0.05, top: 0.42, right: 0.40, bottom: 0.85, zIndex: 1 },
  туфли: { left: 0.48, top: 0.55, right: 0.95, bottom: 0.95, zIndex: 4 },
  обувь: { left: 0.48, top: 0.55, right: 0.95, bottom: 0.95, zIndex: 4 },
  сумка: { left: 0.45, top: 0.25, right: 0.88, bottom: 0.60, zIndex: 5 },
};
...
export const atomicTopBottomBagShoesLayout: LayoutPattern = {
  футболка: { left: 0.05, top: 0.05, right: 0.48, bottom: 0.52, zIndex: 1 },
  топ: { left: 0.05, top: 0.05, right: 0.48, bottom: 0.52, zIndex: 1 },
  брюки: { left: 0.32, top: 0.32, right: 0.72, bottom: 0.88, zIndex: 2 },
  джинсы: { left: 0.32, top: 0.32, right: 0.72, bottom: 0.88, zIndex: 2 },
  обувь: { left: 0.50, top: 0.58, right: 0.95, bottom: 0.95, zIndex: 4 },
  туфли: { left: 0.50, top: 0.58, right: 0.95, bottom: 0.95, zIndex: 4 },
  кроссовки: { left: 0.50, top: 0.58, right: 0.95, bottom: 0.95, zIndex: 4 },
  сумка: { left: 0.05, top: 0.48, right: 0.42, bottom: 0.78, zIndex: 5 },
};
...
export const dressBagShoesLayout: LayoutPattern = {
  пиджак: { left: 0.32, top: 0.05, right: 0.68, bottom: 0.45, zIndex: 2 },
  жакет: { left: 0.32, top: 0.05, right: 0.68, bottom: 0.45, zIndex: 2 },
  платье: { left: 0.05, top: 0.05, right: 0.45, bottom: 0.90, zIndex: 1 },
  туфли: { left: 0.48, top: 0.58, right: 0.95, bottom: 0.95, zIndex: 4 },
  обувь: { left: 0.48, top: 0.58, right: 0.95, bottom: 0.95, zIndex: 4 },
  сумка: { left: 0.45, top: 0.25, right: 0.88, bottom: 0.60, zIndex: 5 },
};
...
export const outerTopBottomBagShoesLayout: LayoutPattern = {
  куртка: { left: 0.05, top: 0.05, right: 0.42, bottom: 0.62, zIndex: 2 },
  пальто: { left: 0.05, top: 0.05, right: 0.42, bottom: 0.62, zIndex: 2 },
  топ: { left: 0.28, top: 0.05, right: 0.65, bottom: 0.48, zIndex: 1 },
  брюки: { left: 0.05, top: 0.50, right: 0.38, bottom: 0.88, zIndex: 1 },
  юбка: { left: 0.05, top: 0.50, right: 0.38, bottom: 0.88, zIndex: 1 },
  туфли: { left: 0.48, top: 0.58, right: 0.95, bottom: 0.95, zIndex: 4 },
  обувь: { left: 0.48, top: 0.58, right: 0.95, bottom: 0.95, zIndex: 4 },
  сумка: { left: 0.45, top: 0.25, right: 0.88, bottom: 0.60, zIndex: 5 },
};
...
export const outerTopLightBottomBagLongShoesLayout: LayoutPattern = {
  ...
  брюки: { left: 0.05, top: 0.50, right: 0.38, bottom: 0.88, zIndex: 1 },
  юбка: { left: 0.05, top: 0.50, right: 0.38, bottom: 0.88, zIndex: 1 },
  туфли: { left: 0.48, top: 0.52, right: 0.95, bottom: 0.95, zIndex: 4 },
  обувь: { left: 0.48, top: 0.52, right: 0.95, bottom: 0.95, zIndex: 4 },
  сумка: { left: 0.45, top: 0.25, right: 0.88, bottom: 0.60, zIndex: 5 },
};
...
export const dressOuterBagShoesLayout: LayoutPattern = {
  куртка: { left: 0.28, top: 0.05, right: 0.65, bottom: 0.55, zIndex: 2 },
  пальто: { left: 0.28, top: 0.05, right: 0.65, bottom: 0.55, zIndex: 2 },
  платье: { left: 0.05, top: 0.05, right: 0.42, bottom: 0.88, zIndex: 1 },
  туфли: { left: 0.48, top: 0.58, right: 0.95, bottom: 0.95, zIndex: 4 },
  обувь: { left: 0.48, top: 0.58, right: 0.95, bottom: 0.95, zIndex: 4 },
  сумка: { left: 0.45, top: 0.25, right: 0.88, bottom: 0.60, zIndex: 5 },
};
