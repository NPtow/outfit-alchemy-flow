      ...
      >
        ...
        <div className="absolute bottom-16 left-6 right-6 z-20">
          <button
            ...
            className="w-full px-6 py-4 rounded-full font-semibold text-lg transition-all duration-200 font-gota border-2 border-border hover:border-primary flex items-center justify-center gap-3 bg-transparent"
            style={{ color: '#A88AED' }}
          >
